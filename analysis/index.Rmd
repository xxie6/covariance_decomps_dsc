...
* Exploration of [balanced tree setting with unequal sized groups](baltree_unequal_popsizes_exploration.html)  
* Comparison of [three different initializations with large K input](initialization_larger_K_comparison.html)  
...
* Exploration of [initialization in the sparse overlapping setting](init_comparison_overlap_setting.html)  
